class AttendancesController < ApplicationController
  ...
  # GET /attendances.xml
  def index
    @opendoor_students = Student.find(:all, :conditions => "school_id = 1 and inactive = false", :order => "last_name")
    @fairview_students = Student.find(:all, :conditions => "school_id = 2 and inactive = false", :order => "last_name")
  ...
  def create
    @students = Student.find(:all, :conditions => "inactive = false", :order => "last_name")
